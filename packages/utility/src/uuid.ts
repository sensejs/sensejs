...
const allMacAddresses = Object.values(networkInterfaces)
  .filter((value): value is os.NetworkInterfaceInfo[] => typeof value !== 'undefined')
...
const uuidV1Suffixes =
  allMacAddresses.length === 0
...
/**
 * @deprecated Use uuidV1 from @sensejs/core instead
 */
