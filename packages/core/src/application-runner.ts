...
export class ApplicationRunner {
  ...
  #runSubscription: Subscription | null = null;

  #stoppedSubject = new Subject<ExitOption>();
  #uncaughtErrorObservable;
  ...
  #createProcessManager<T>(runOption: RunnerOption<T>) {
  ...
  #performRunModule<M extends {}, K extends keyof M, T = never>(
